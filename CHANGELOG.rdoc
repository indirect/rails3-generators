...
* remove generators that exist in other libraries (mongoid, mustache, and fabricator to name a few)

== 0.16.0
* optimize
  * Machinist removed. Machinist 2 (https://github.com/notahat/machinist) has its own generators.
